  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      {mostrarModalAprobacion && comprobanteSeleccionado && (
        <div className="fixed inset-0 z-50 overflow-y-auto overflow-x-hidden bg-black/50 dark:bg-black/70 flex items-center justify-center p-4 min-h-screen" onClick={() => setMostrarModalAprobacion(false)}>
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full my-4 max-h-[calc(100vh-2rem)] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            <div className="p-6">
      ...
      {mostrarModalWhatsApp && pagoAprobado && (
        <div className="fixed inset-0 z-50 overflow-y-auto overflow-x-hidden bg-black/50 dark:bg-black/70 flex items-center justify-center p-4 min-h-screen">
          <div className="bg-white dark:bg-gray-800 rounded-lg max-w-md w-full border border-gray-300 dark:border-gray-700 mx-4 my-4 max-h-[calc(100vh-2rem)] overflow-y-auto">
            <div className="p-4 md:p-6">
